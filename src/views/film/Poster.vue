...
export default {
  ...
  methods: {
    ...
    handleUploadSuccess(response, file, fileList) {
      this.fileList = [file]
      this.uploadPoster.url = response
    },

    submitUpload() {
      AddPoster(this.uploadPoster).then(res => {
        this.uploadPoster.createAt = this.formatDateTime();
        this.posterList.push({
          url: this.uploadPoster.url,
          title: this.uploadPoster.title,
          status: this.uploadPoster.status,
          createAt: this.uploadPoster.createAt
        });
