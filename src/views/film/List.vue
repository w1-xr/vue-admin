    ...
    <el-dialog
      ...
      <el-form ref="form" style="padding: 20px" :model="form" label-width="80px">
        ...
        <el-form-item label="上映时间">
          <el-col :span="11">
            <el-date-picker type="date" :picker-options="pickerOptions" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="form.releaseTime" style="width: 100%;"></el-date-picker>
          </el-col>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="arrangement" label-width="80px">
        ...
        <el-form-item style="width: 500px" label="放映日期">
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择日期" v-model="arrangement.date" :picker-options="pickerOptions"
        ...
        <el-form-item style="width: 500px" label="放映时间">
          <el-col :span="11">
            <el-time-picker placeholder="开始时间" value-format="HH:mm:ss"  @change="handleStartTimeChange"
             v-model="arrangement.startTime" style="width: 100%;"></el-time-picker>
          </el-col>
          <el-col style="text-align: center" class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-time-picker disabled placeholder="结束时间" value-format="HH:mm:ss" v-model="arrangement.endTime" style="width: 100%;"></el-time-picker>
          </el-col>
        </el-form-item>
		...
		<el-form-item label="折扣" v-show="showDisCount">
		  <el-input v-model="arrangement.disCountInfo"></el-input>
		</el-form-item>
  ...
  methods: {
    ...
    handleStartTimeChange(time) {
      if (time) {
        ...
        let totalMinutes = minutes + this.filmList[this.clickIndex].duration;
